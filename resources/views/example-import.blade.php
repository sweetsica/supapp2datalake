        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    ...
                    <form style="background-color: wheat" action="{{route('upload.file.demo')}}" method="POST"
                        ...
                        <div>
                            @csrf
                            <div class="row">
                                Nhân viên đặt <input type="text" class="input" name="order_name">
                            </div>
                            <div class="row">
                                Mã nhân viên <input type="text" class="input" name="carer_code">
                            </div>
                            <div class="row">
                                Ngày đặt <input type="text" class="input" name="bill_order_time">
                            </div>
                            <div class="row">
                                Nhóm <input type="text" class="input" name="bill_group">
                            </div>
                        </div>

                        <button onclick="startUploadFile()">
                            Upload
                        </button>
                    </form>
                    {{--                    <script>--}}
